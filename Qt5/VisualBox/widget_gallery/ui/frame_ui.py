...
from PyQt5.QtWidgets import QWidget, QGroupBox, QFrame, QPushButton, QToolButton, QCalendarWidget, QGridLayout, \
    QSpinBox, QRadioButton, QCheckBox, QVBoxLayout, QHBoxLayout, QScrollArea
