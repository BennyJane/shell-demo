...
from PyQt5.QtWidgets import QGroupBox, QPushButton, QToolButton, QRadioButton, QCheckBox, QGridLayout, QLabel, \
    QVBoxLayout, QSpinBox, QComboBox, QLineEdit, QDateTimeEdit, QTabWidget, QTableView, QTextEdit, QListWidget, \
    QTreeWidget, QTreeWidgetItem, QToolBox, QSlider, QDial, QProgressBar, QLCDNumber, QWidget, QSplitter, QScrollArea
